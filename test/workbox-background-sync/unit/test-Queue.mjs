...
import {DB_NAME, DB_VERSION, OBJECT_STORE_NAME} from 'workbox-background-sync/utils/constants.mjs';
...
describe(`[workbox-background-sync] Queue`, function() {
  ...
  beforeEach(async function() {
    ...
    // Stub the object so the code won't error, but don't implement it the
    // interface because we don't want to test a fake implementation.
    self.registration = {};
  });
