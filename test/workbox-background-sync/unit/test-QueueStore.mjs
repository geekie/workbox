...
import {DB_NAME, DB_VERSION, OBJECT_STORE_NAME, INDEXED_PROP} from 'workbox-background-sync/utils/constants.mjs';
import {QueueStore} from 'workbox-background-sync/models/QueueStore.mjs';
import StorableRequest from 'workbox-background-sync/models/StorableRequest.mjs';
...
// const db = new DBWrapper(DB_NAME, DB_VERSION, {
